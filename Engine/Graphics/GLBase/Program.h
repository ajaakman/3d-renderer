...
class Program
{
	...
	private:
		...
		const unsigned CompileShader(const unsigned & type, const std::string& source);
		const unsigned CreateShader(const std::string& vertexShader, const std::string& fragmentShader);
